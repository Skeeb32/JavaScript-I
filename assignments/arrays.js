...
console.log(
  `The car with an id of 33 was made on ${inventory[32].car_year}, this is the make of the car ${inventory[32].car_make}, this is the model of the car ${inventory[32].car_model}`
);
